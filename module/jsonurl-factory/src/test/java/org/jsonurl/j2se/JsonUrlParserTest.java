...
class JsonUrlParserTest {
    ...
    void testConstruct() {
        ...
        assertSame(
            ...
            new JsonUrlParser(JavaValueFactory.DOUBLE).factory(),
            testName);
        ...
        assertEquals(
            limits,
            new JsonUrlParser(JavaValueFactory.DOUBLE, limits).limits(),
            testName);

        assertEquals(
            options,
            new JsonUrlParser(JavaValueFactory.DOUBLE, options).options(),
            testName);
